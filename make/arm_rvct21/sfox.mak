...
LIBOBJS = $(WORKDIR)\FS_Rfc822.obj    \
		...
		$(WORKDIR)\FS_DcdPkg.obj \
		$(WORKDIR)\FS_DcdLib.obj \
		$(WORKDIR)\FS_DcdMain.obj \
		$(WORKDIR)\FS_Stock.obj \
		$(WORKDIR)\FS_StockMain.obj
...
$(WORKDIR)\FS_DcdPkg.obj : $(ROOTDIR)\src\dcd\FS_DcdPkg.c
	$(CC) $(CCOPT) $(OOPT)$@ $(ROOTDIR)\src\dcd\FS_DcdPkg.c
$(WORKDIR)\FS_DcdLib.obj : $(ROOTDIR)\src\dcd\FS_DcdLib.c
	$(CC) $(CCOPT) $(OOPT)$@ $(ROOTDIR)\src\dcd\FS_DcdLib.c
$(WORKDIR)\FS_DcdMain.obj : $(ROOTDIR)\src\dcd\FS_DcdMain.c
	$(CC) $(CCOPT) $(OOPT)$@ $(ROOTDIR)\src\dcd\FS_DcdMain.c

$(WORKDIR)\FS_Stock.obj : $(ROOTDIR)\src\stk\FS_Stock.c
	$(CC) $(CCOPT) $(OOPT)$@ $(ROOTDIR)\src\stk\FS_Stock.c
$(WORKDIR)\FS_StockMain.obj : $(ROOTDIR)\src\stk\FS_StockMain.c
	$(CC) $(CCOPT) $(OOPT)$@ $(ROOTDIR)\src\stk\FS_StockMain.c
